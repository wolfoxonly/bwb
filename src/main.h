...
static const int64 MAX_MINT_PROOF_OF_WORK = 9999999 * COIN;//最大挖到的利息值
...
static const int STAKE_MIN_AGE = 60 * 60 * 24 * 30; // minimum age for coin age<coingo.vip>
...
static const uint256 hashGenesisBlockOfficial("0x000000ecf193298720b66f49ebf43620c10eb55cb6df9802c4bae8364e37f271");
...
#ifdef TESTING
void BwbcoinMiner(CWallet *pwallet, bool fProofOfStake, bool fGenerateSingleBlock = false);
#else
...
public:
    ...
    */
    ...
    /** Amount of Bwbcoins spent by this transaction.
    ...
    /** Amount of Bwbcoins coming in to this transaction
...
public:
    ...
    /**
     * Duplicate from Bwbcoinrpc that originaly define this method.
