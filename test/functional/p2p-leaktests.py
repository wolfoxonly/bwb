...
Also test that nodes that send unsupported service bits to Bwbcoind are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if Bwbcoind ban behavior changes
    def on_open(self):
        super().on_open()
...
class P2PLeakTest(BwbcoinTestFramework):
