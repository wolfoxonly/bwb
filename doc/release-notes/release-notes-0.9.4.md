Bwbcoin Core version 0.9.4 is now available from:

  https://Bwbcoin.org/bin/0.9.4/
...
this update is incompatible with the Bwbcoin system and could lead to consensus
forks.

Bwbcoin Core released binaries from https://Bwbcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~Bwbcoin/+archive/ubuntu/Bwbcoin
- A third-party or self-compiled Bwbcoin Core

upgrade to Bwbcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
