Bwbcoin Core version 0.10.4 is now available from:

  <https://Bwbcoin.org/bin/Bwbcoin-core-0.10.4/>
...
- #6953 `43c2789` Split Bwbcoin-tx into its own package
- #6953 `dfe0d4d` Include Bwbcoin-tx binary on Debian/Ubuntu
