...
Bwbcoin Core version *version* is now available from:

  <https://Bwbcoin.org/bin/Bwbcoin-core-*version*/>
...
GCC 4.8.x
--------------
The minimum version of GCC required to compile Bwbcoin Core is now 4.8. No effort will be
