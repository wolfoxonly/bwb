Bwbcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/Bwbcoin/files/Bwbcoin/Bwbcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bwbcoin
...
New/changed settings (command-line or Bwbcoin.conf file)
--------------------------------------------------------
