...
// Copyright (c) 2009-2012 The Bwbcoin Core developers
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bwbcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
     {"node1.bwbcoin.com","node1.bwbcoin.com"},
     {"node3.bwbcoin.com", "node3.bwbcoin.com"},
     {"node5.bwbcoin.com","node5.bwbcoin.com"},
     {"node7.bwbcoin.com", "node7.bwbcoin.com"},
     {"node9.bwbcoin.com","node9.bwbcoin.com"},
	 {"node2.bwbcoin.com","node2.bwbcoin.com"},
     {"node4.bwbcoin.com", "node4.bwbcoin.com"},
     {"node6.bwbcoin.com","node6.bwbcoin.com"},
     {"node8.bwbcoin.com", "node8.bwbcoin.com"},
...
static const char *strTestNetDNSSeed[][2] = {
     {"node1.bwbcoin.com","node2.bwbcoin.com"},
     {"node3.bwbcoin.com", "node4.bwbcoin.com"},
     {"node5.bwbcoin.com","node6.bwbcoin.com"},
     {"node7.bwbcoin.com", "node8.bwbcoin.com"},
     {"node9.bwbcoin.com","node1.coingo.vip"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bwbcoin is probably already running."), addrBind.ToString().c_str());
        else
