...
class BIP66Test(BwbcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # Bwbcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and Bwbcoind produces more specific reject
            # reasons.
