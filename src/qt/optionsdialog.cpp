    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new BwbcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->BwbcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Bwbcoin."), QMessageBox::Ok);
