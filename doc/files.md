...
* Bwbcoin.conf: contains configuration settings for Bwbcoind or Bwbcoin-qt
* Bwbcoind.pid: stores the process id of Bwbcoind while running
...
* debug.log: contains debug information and general logging generated by Bwbcoind or Bwbcoin-qt
