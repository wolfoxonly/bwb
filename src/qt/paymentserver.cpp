...
const QString BITCOIN_IPC_PREFIX("Bwbcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Bwbcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Bwbcoin: click-to-pay handler");
    else
...
{
    // clicking on Bwbcoin: URLs creates FileOpen events on the Mac:
