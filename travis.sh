...
export SDK_URL=https://Bwbcoincore.org/depends-sources/sdks
...
#script:
if [ "$CHECK_DOC" = 1 -a "$TRAVIS_REPO_SLUG" = "Bwbcoin/Bwbcoin" -a "$TRAVIS_PULL_REQUEST" = "false" ]; then 
	while read LINE; do 
