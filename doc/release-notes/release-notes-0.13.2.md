Bwbcoin Core version 0.13.2 is now available from:

  <https://Bwbcoin.org/bin/Bwbcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update Bwbcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow Bwbcoin-tx to create v2 transactions (btcdrak)
