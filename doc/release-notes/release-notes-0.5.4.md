Bwbcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/Bwbcoin/files/Bwbcoin/Bwbcoin-0.5.4/
...
http://gitorious.org/Bwbcoin/Bwbcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bwbcoin-Qt notifications under Growl 1.3.
Increase required age of Bwbcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBwbcoin properly when installing Bwbcoin-Qt over it. (Windows)
