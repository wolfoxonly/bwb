...
# TestNode: A peer we use to send messages to Bwbcoind, and store responses.
...
class CompactBlocksTest(BwbcoinTestFramework):
    ...
    # This test actually causes Bwbcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that Bwbcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for Bwbcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # Bwbcoind will not send blocktxn responses for blocks whose height is
