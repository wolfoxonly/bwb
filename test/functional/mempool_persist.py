...
By default, Bwbcoind will dump mempool on shutdown and
...
class MempoolPersistTest(BwbcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(1)
        self.start_node(2)
        # Give Bwbcoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent Bwbcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
